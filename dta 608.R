...
plot(1,1,lwd=.75,pch=1,
     ...
     #     ,ylim=c(270,265)
     ,ylim=c(max(age.608[,'Depth..CSF.A.'],na.rm=T),min(age.608[,'Depth..CSF.A.'],na.rm=T))
 #    ,xlim=c(min(age.608[,'Age'],na.rm=T),max(age.608[,'Age'],na.rm=T))
,xlim=c(20,25)
 ,type='n'
     ,main="Hole 608"
)
...
#)
#Highlight kugleri
points(age.608[which(age.608[,'Datum'] == 'P. kugleri'),'Age'],
       age.608[which(age.608[,'Datum'] == 'P. kugleri'),'Depth..CSF.A.'],
       pch="+",col='black',cex=2)
...
points(age.608[which(age.608[,'Datum.Type'] == 'Stron' & age.608[,"Top.Base"] == "P"),'Age'],#-1.4,
       age.608[which(age.608[,'Datum.Type'] == 'Stron' & age.608[,"Top.Base"] == "P"),'Depth..CSF.A.'],
       pch=16,col='darkorchid1',lwd=1)


##Rad Age control points
points(age.608[which(age.608[,'Datum.Type'] == 'Rad' & age.608[,'Top.Base'] == 'T'),'Age'],
       age.608[which(age.608[,'Datum.Type'] == 'Rad' & age.608[,'Top.Base'] == 'T'),'Depth..CSF.A.'],
       pch=25,col='brown',lwd=3)
points(age.608[which(age.608[,'Datum.Type'] == 'Rad' & age.608[,'Top.Base'] == 'B'),'Age'],
       age.608[which(age.608[,'Datum.Type'] == 'Rad' & age.608[,'Top.Base'] == 'B'),'Depth..CSF.A.'],
       pch=24,col='brown',lwd=3)
points(age.608[which(age.608[,'Datum.Type'] == 'Rad' & age.608[,'Top.Base'] == 'Tc'),'Age'],
       age.608[which(age.608[,'Datum.Type'] == 'Rad' & age.608[,'Top.Base'] == 'Tc'),'Depth..CSF.A.'],
       pch=4,col='brown',lwd=3)
#Primary Rad Markers
points(age.608[which(age.608[,'Datum.Type'] == 'Rad' 
                      & age.608[,'Top.Base'] == 'T'
                      & age.608[,'Primary'] == "Yes"),'Age'],
       age.608[which(age.608[,'Datum.Type'] == 'Rad' 
                      & age.608[,'Top.Base'] == 'T'
                      & age.608[,'Primary'] == "Yes"),'Depth..CSF.A.'],
